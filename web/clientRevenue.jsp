...
<html>
    ...
    <body>
        ...
        <sql:query dataSource = "${snapshot}" var = "s">
            SELECT LastName, FirstName, P.SSN,O.Email, Sum(Fee) AS TotalRevenue
            FROM transactioninfo T, orderinfo O, trade R, person P, clients c
            WHERE T.TraxID= R.TraxId AND O.OrderId=R.OrderId And P.SSN=c.SSN AND O.Email=C.email
            GROUP BY O.Email
        ...
        <div class="container">
            <h2>Client generating the most revenue</h2>
            <br>
            <table class="table">
                <thead>
                    <tr>
