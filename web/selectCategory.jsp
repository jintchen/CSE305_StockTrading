<%-- 
    ...
    Created on : May 2, 2016, 2:11:27 AM
    Author     : Tian
--%>
            ...
            <div class="content-container clearfix">
                ...
                <div class="col-md-12">
                    <div  style="font-size:150%;">
                        <form action="ViewRevenueServlet" method="GET"  >
                            <h2><strong>View Revenue by Stock Symbol:</strong></h2>
                            ...
                            <div class="modal-footer">
                                ...
                                <div>
                                    <button type="submit" value = "Submit" class="btn btn-primary btn-lg btn-block" >View Revenue</button>
                                </div>
                        ...
                        <br>
                        <form action="ViewRevenueServlet" method="GET"  >
                            <h2><strong>View Revenue by Stock Type:</strong></h2>
                            <div class="modal-body">
                                <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
                                                   url ="jdbc:mysql://mysql2.cs.stonybrook.edu:3306/qixchen"
                                                   user = "qixchen" password="108605598" />
                                ...
                                <div style="font-size:20px;">
                                    <Span><Strong>Stock Symbol:</Strong></Span>
                                    <select style="margin-right: 40%" id="selectSign" onchange="selectSignIn();" name="stockType">
                                        <c:forEach var = "row" items ="${result.rows}">
                        ...
                        <br>
                        <form action="ViewRevenueServlet" method="GET"  >
                            <h2><strong>View Revenue by customer name:</strong></h2>
                            <div class="modal-body">
                                <div style="font-size:20px;">
